...
var $progress = {
    update: function (id, value, label) {
        ...
        $('#progressbar-' + id).find('.progressbar-in').removeClass('progressbar');
        $('#progressbar-' + id).find('.progressbar-in').removeClass('progressbar-infinite');

        if (isNaN(parseInt(value))) {
            $('#progressbar-' + id).find('.progressbar-in').addClass('progressbar-infinite');
            $app.setProgressbar(progressbar, null);
        } else {
            $('#progressbar-' + id).find('.progressbar-in').addClass('progressbar');
...
var db_settings = [
    ...
    { name: 'discount-before-surcharge', type: 'boolean', value: 'false', description: '' },
    { name: 'discount-split-view', type: 'boolean', value: 'false', description: '' },
    { name: 'discount-validation', type: 'boolean', value: 'false', description: '' },
    { name: 'last-minute-booking', type: 'number', value: '0', description: '' },
    { name: 'length-of-voucher-number', type: 'number', value: '9', description: '' },
    { name: 'payment-combinable', type: 'boolean', value: 'false', description: '' },
    { name: 'payment-manual', type: 'boolean', value: 'false', description: '' },
    { name: 'payment-default', type: 'string', value: 'ca', description: '' },
    { name: 'print-company-logo', type: 'boolean', value: 'false', description: '' },
    ...
    { name: 'required-guest-details', type: 'boolean', value: 'false', description: '' },
    ...
    { name: 'footer-branch-company', type: 'boolean', value: 'true', description: '' },
    ...
    /* LOROPARQUE */
    { name: 'lp-status', type: 'boolean', value: 'false', description: 'status connection integrasi loroparque' },
    { name: 'lp-status-dev', type: 'text', value: 'loroparque_live', description: 'status connection integrasi loroparque' }
...
var $f_login = {
    required_guest_details: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-required-guestdetails').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-required-guestdetails').parents('.item-content').removeClass('disabled');
            }
        }
    },
    discount_before_surcharge: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-discount-beforesurcharge').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-discount-beforesurcharge').parents('.item-content').removeClass('disabled');
            }
        }
    },
    discount_split_view: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-discount-splitview').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-discount-splitview').parents('.item-content').removeClass('disabled');
            }
        }
    },
    discount_validation: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-discount-validation').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-discount-validation').parents('.item-content').removeClass('disabled');
            }
        }
    },
    last_minute_booking: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-lastminute-booking').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-lastminute-booking').parents('.item-content').removeClass('disabled');
            }
        }
    },
    payment_combinable: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-payment-combinable').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-payment-combinable').parents('.item-content').removeClass('disabled');
            }
        }
    },
    payment_manual: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-payment-manual').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-payment-manual').parents('.item-content').removeClass('disabled');
            }
        }
    },
    payment_default: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-payment-default').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-payment-default').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_company_logo: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-print-companylogo').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-print-companylogo').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_size: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-print-size').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-print-size').parents('.item-content').removeClass('disabled');
            }
        }
    },
    voucher_connect: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-voucher-connect').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-voucher-connect').parents('.item-content').removeClass('disabled');
            }
        }
    },
    voucher_amend: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-voucher-amend').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-voucher-amend').parents('.item-content').removeClass('disabled');
            }
        }
    },
    voucher_manual: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#login-input-voucher-manual').parents('.item-content').addClass('disabled');
            } else {
                $('#login-input-voucher-manual').parents('.item-content').removeClass('disabled');
            }
        }
    }
}
...
var $f_settings = {
    ...
    required_guest_details: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-required-guestdetails').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-required-guestdetails').parents('.item-content').removeClass('disabled');
            }
        }
    },
    discount_before_surcharge: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-discount-beforesurcharge').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-discount-beforesurcharge').parents('.item-content').removeClass('disabled');
            }
        }
    },
    discount_split_view: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-discount-splitview').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-discount-splitview').parents('.item-content').removeClass('disabled');
            }
        }
    },
    discount_validation: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-discount-validation').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-discount-validation').parents('.item-content').removeClass('disabled');
            }
        }
    },
    last_minute_booking: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-lastminute-booking').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-lastminute-booking').parents('.item-content').removeClass('disabled');
            }
        }
    },
    payment_combinable: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-payment-combinable').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-payment-combinable').parents('.item-content').removeClass('disabled');
            }
        }
    },
    payment_manual: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-payment-manual').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-payment-manual').parents('.item-content').removeClass('disabled');
            }
        }
    },
    payment_default: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-payment-default').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-payment-default').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_company_logo: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-print-companylogo').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-print-companylogo').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_device: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-print-device').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-print-device').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_header: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-print-header').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-print-header').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_size: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                ...
                $('#settings-print-size').parents('.item-content').removeClass('disabled');
            }
        }
    },
    print_barcode: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-print-barcode').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-print-barcode').parents('.item-content').removeClass('disabled');
            }
        }
    },
    barcode_type: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-barcode-type').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-barcode-type').parents('.item-content').removeClass('disabled');
            }
        }
    },
    barcode_length: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-length-barcode').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-length-barcode').parents('.item-content').removeClass('disabled');
            }
        }
    },
    barcode_hri: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-barcode-hri').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-barcode-hri').parents('.item-content').removeClass('disabled');
            }
        }
    },
    voucher_connect: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-voucher-connect').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-voucher-connect').parents('.item-content').removeClass('disabled');
            }
        }
    },
    voucher_amend: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-voucher-amend').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-voucher-amend').parents('.item-content').removeClass('disabled');
            }
        }
    },
    voucher_manual: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-voucher-manual').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-voucher-manual').parents('.item-content').removeClass('disabled');
            }
        }
    },
    ...
    footer_branch_company: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-footer-branch-company').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-footer-branch-company').parents('.item-content').removeClass('disabled');
            }
        }
    },
    /* ITOS DEVICE */
    ...
    tpv_device: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                ...
                $('#settings-tpv-device').parents('.item-content').removeClass('disabled');
            }
        }
    },
    tpv_address: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-tpv-address').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-tpv-address').parents('.item-content').removeClass('disabled');
            }
        }
    },
    tpv_xsource: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-tpv-xsource').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-tpv-xsource').parents('.item-content').removeClass('disabled');
            }
        }
    },
    tpv_username: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-tpv-username').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-tpv-username').parents('.item-content').removeClass('disabled');
            }
        }
    },
    tpv_password: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-tpv-password').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-tpv-password').parents('.item-content').removeClass('disabled');
            }
        }
    },
    tpv_qr: {
    ...
    tpv_qrsize: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                ...
                $('#settings-tpv-qrsize').parents('.item-content').removeClass('disabled');
            }
        }
    },
    tpv_qrposition: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-tpv-qrposition').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-tpv-qrposition').parents('.item-content').removeClass('disabled');
            }
        }
    },
    ...
    lp_status: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                ...
                $('#settings-lp-status').parents('.item-content').removeClass('disabled');
            }
        }
    },
    ...
    lp_status_dev: {
        ...
        disabled: function (status) {
            if (string_to_boolean(status)) {
                $('#settings-lp-status-dev').parents('.item-content').addClass('disabled');
            } else {
                $('#settings-lp-status-dev').parents('.item-content').removeClass('disabled');
            }
        }
    }
}
...
$(document).ready(function () {
    ...
    $('#autocomplete-standalone-language').on('click', function () {
        get_language(function (data) {
            ...
            $language.searchbar =
                $app.searchbar('.searchbar.language', {
    ...
    CALENDAR_TEMPLATE += '<a href="#" class="link icon-only"><i class="icon icon-back"></i></a>';
    CALENDAR_TEMPLATE += '</div>';
    CALENDAR_TEMPLATE += '<div class="center"></div>';
    CALENDAR_TEMPLATE += '<div class="right">';
    CALENDAR_TEMPLATE += '<a href="#" class="link icon-only"><i class="icon icon-forward"></i></a>';
    CALENDAR_TEMPLATE += '</div>';
    CALENDAR_TEMPLATE += '</div>';
    CALENDAR_TEMPLATE += '</div>';
...
function check_for_sync_transaction(callback) {
    ssql_load('LIST_TRANSACTION_SYNC', 'ALL', function (ssql_data) {
        ...
        sql_data(ssql, function (result) {
            if (result.length) {
                $app.alert($STRING.required_sync_transaction.replace(/@:count:/g, result.length), $STRING.info_important, function () {
...
function settings_form_data() {
    var data = [];
    /* basic */
    data.push({ name: 'server', value: $f_settings.domain.get(), description: '' });
    data.push({ name: 'company', value: $f_settings.registration_id.get(), description: $f_settings.company_name.get() });
    data.push({ name: 'branch', value: $f_settings.branch.get(), description: $f_settings.branch.get('label') });
    data.push({ name: 'user', value: $f_settings.user.get(), description: $f_settings.user.get('label') });
    data.push({ name: 'market', value: $f_settings.market.get(), description: $f_settings.market.get('label') });
    data.push({ name: 'language', value: $f_settings.language.get(), description: $f_settings.language.get('label') });
    data.push({ name: 'currency', value: $f_settings.currency.get(), description: $f_settings.currency.get('label') });
    /* additional */
    data.push({ name: 'company-active-date', value: $f_settings.company_active_date.get(), description: '' });
    data.push({ name: 'initial-company', value: $f_settings.company_alias.get(), description: '' });
    data.push({ name: 'initial-user', value: $f_settings.user_initial.get(), description: '' });
    data.push({ name: 'required-guest-details', value: $f_settings.required_guest_details.get(), description: '' });
    data.push({ name: 'discount-before-surcharge', value: $f_settings.discount_before_surcharge.get(), description: '' });
    data.push({ name: 'discount-split-view', value: $f_settings.discount_split_view.get(), description: '' });
    data.push({ name: 'discount-validation', value: $f_settings.discount_validation.get(), description: '' });
    data.push({ name: 'last-minute-booking', value: $f_settings.last_minute_booking.get(), description: '' });
    data.push({ name: 'payment-combinable', value: $f_settings.payment_combinable.get(), description: '' });
    data.push({ name: 'payment-manual', value: $f_settings.payment_manual.get(), description: '' });
    data.push({ name: 'payment-default', value: $f_settings.payment_default.get(), description: '' });
    data.push({ name: 'print-company-logo', value: $f_settings.print_company_logo.get(), description: '' });
    data.push({ name: 'print-device', value: $f_settings.print_device.get(), description: '' });
    data.push({ name: 'print-size', value: $f_settings.print_size.get(), description: '' });
    data.push({ name: 'print-header', value: $f_settings.print_header.get(), description: '' });
    data.push({ name: 'print-barcode', value: $f_settings.print_barcode.get(), description: '' });
    data.push({ name: 'barcode-type', value: $f_settings.barcode_type.get(), description: '' });
    data.push({ name: 'barcode-length', value: $f_settings.barcode_length.get(), description: '' });
    data.push({ name: 'barcode-hri', value: $f_settings.barcode_hri.get(), description: '' });
    data.push({ name: 'tax-for-credit-card', value: $f_settings.tax_for_credit_card.get(), description: '' });
    data.push({ name: 'voucher-connect', value: $f_settings.voucher_connect.get(), description: '' });
    data.push({ name: 'voucher-amend', value: $f_settings.voucher_amend.get(), description: '' });
    data.push({ name: 'voucher-manual', value: $f_settings.voucher_manual.get(), description: '' });
    /* string */
    data.push({ name: 'address-of-branch', value: $f_settings.address_of_branch.get(), description: '' });
    data.push({ name: 'address-of-company', value: $f_settings.address_of_company.get(), description: '' });
    data.push({ name: 'cancellation', value: $f_settings.cxl_policy.get(), description: '' });
    data.push({ name: 'hotline', value: $f_settings.hotline.get(), description: '' });
    data.push({ name: 'phone', value: $f_settings.phone.get(), description: '' });
    data.push({ name: 'phone-branch', value: $f_settings.phone_branch.get(), description: '' });
    data.push({ name: 'text-cx-branch', value: $f_settings.text_cx_branch.get(), description: '' });
    data.push({ name: 'other-information', value: $f_settings.other_information.get(), description: '' });
    data.push({ name: 'footer-branch-company', value: $f_settings.footer_branch_company.get(), description: '' });

    //------ ITOS DEVICE
    data.push({ name: 'tpv-device', value: $f_settings.tpv_device.get(), description: '' });
    data.push({ name: 'tpv-address', value: $f_settings.tpv_address.get(), description: '' });
    data.push({ name: 'tpv-xsource', value: $f_settings.tpv_xsource.get(), description: '' });
    data.push({ name: 'tpv-username', value: $f_settings.tpv_username.get(), description: '' });
    data.push({ name: 'tpv-password', value: $f_settings.tpv_password.get(), description: '' });
    data.push({ name: 'tpv-qr', value: $f_settings.tpv_qr.get(), description: '' });
    data.push({ name: 'tpv-qrsize', value: $f_settings.tpv_qrsize.get(), description: '' });
    data.push({ name: 'tpv-qrposition', value: $f_settings.tpv_qrposition.get(), description: '' });

    //------ LOROPARQUE
    data.push({ name: 'lp-status', value: $f_settings.lp_status.get(), description: '' });
    data.push({ name: 'lp-status-dev', value: $f_settings.lp_status_dev.get(), description: '' });
...
function settings_create(arr, callback) {
    ...
    ssql += " SELECT '" + data.name + "','" + data.type + "','" + data.value + "','" + data.description + "' "
    ssql += " WHERE NOT EXISTS(SELECT * FROM config WHERE name = '" + data.name + "'); "
...
function settings_form_load() {
    ...
    $f_settings.discount_before_surcharge.set($SETTINGS.discount_before_surcharge);
...
function get_language(callback) {
    ...
    $.ajax({
        ...
        data: '&act=settings-language&domain=' + domain + '&branch=' + branch + '&user=' + user,
        dataType: 'json',
        success: function (result) {
            callback(result);
        }
