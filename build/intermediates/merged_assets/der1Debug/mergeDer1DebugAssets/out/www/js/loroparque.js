    ...
    return {
        init: function (param, callback) {
            ...
            $.ajax({
                ...
                success: function (r) {
                    ...
                    $lp.insert_log('IniciarLog', JSON.stringify(param.login), JSON.stringify(r), 'success', function () {
                ...
                error: function (e) {
                    console.log(e);
                    $loader.hide();
                    $lp.insert_log('IniciarLog', JSON.stringify(param.login), JSON.stringify(e), 'error', function () {
                        $app.modal({
                            title: 'Error',
        ...
        HIBDisponible: function (param, month, year, callback) {
            ...
            $.ajax({
                ...
                contentType: 'application/json',
                success: function (r) {
                    $lp.insert_log('HIBDisponible', JSON.stringify($paramdispo), JSON.stringify(r), 'success', function () {
                ...
                error: function (e) {
                    $lp.insert_log('HIBDisponible', JSON.stringify($paramdispo), JSON.stringify(e), 'error', function () {
                        console.log(e)
        ...
        ReservaAforo_noBonoID: function (param, callback) {
            $.ajax({
                ...
                contentType: 'application/json',
                success: function (r) {
                    $lp.insert_log('ReservaAforo', JSON.stringify(param), JSON.stringify(r), 'success', function () {
                        if (r.Mensajes.length !== 0) {
                            console.log(r.Mensajes[0]);
                            $loader.hide();
                            $app.alert(r.Mensajes[0].DescripcionMensaje, 'ERROR: ' + r.Mensajes[0].CodigoMensaje);
                ...
                error: function (e) {
                    $lp.insert_log('ReservaAforo', JSON.stringify(param), JSON.stringify(e), 'error', function () {
                        console.log(e)
                        $app.alert(e, 'Error');
                        $loader.hide();
                    });
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $.ajax({
                                ...
                                success: function (rr) {
                                    console.log(rr);
                                    $lp.insert_log('Insercion', JSON.stringify($baffer_tmplpinsercion), JSON.stringify(rr), 'success', function () {

                                        if (rr.Mensajes.length !== 0) {
                                            $loader.hide();
                                            // $app.alert(rr.Mensajes[0].DescripcionMensaje, 'ERROR: ' + rr.Mensajes[0].CodigoMensaje);
                                            // return false;
                                            //--- perubahan jika error di LP tetap jalankan checkout_after()
                                            alert('ERROR: ' + r.Mensajes[0].DescripcionMensaje + ' ' + r.Mensajes[0].CodigoMensaje);
                                            checkout_after();
                                        } else {
                                ...
                                error: function (e) {
                                    $lp.insert_log('Insercion', JSON.stringify($baffer_tmplpinsercion), JSON.stringify(e), 'error', function () {
                                        $app.alert(e, 'Error');
                                        $loader.hide();
                                        return false;
                                    });
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $.ajax({
                                ...
                                success: function (r) {
                                    console.log(r)
                                    $lp.insert_log('Insercion', JSON.stringify($baffer_tmplpinsercion), JSON.stringify(r), 'success', function () {
                                        if (r.Mensajes.length !== 0) {
                                            $loader.hide();
                                            //--- perubahan jika error di LP tetap jalankan checkout_after()
                                            alert('ERROR: ' + r.Mensajes[0].DescripcionMensaje + ' ' + r.Mensajes[0].CodigoMensaje);
        ...
        insert_log: function (act, rq, rs, sts, callback) {
            console.log('insert_log', act, rq, rs)
            var module = get_core_module();
            var serialize = 'act=lp-insert-log'
            serialize += '&idx_mf=' + SESSION.transaction_mf
            serialize += '&ac=' + act
            serialize += '&rq=' + rq
            serialize += '&rs=' + rs
            serialize += '&sts=' + sts
            serialize += '&idx_usr=' + $SETTINGS.user.id
